...
if (command === "mute") {
  ...
  let modlog = message.guild.channels.find('name', 'dyno-logs');
  let muteRole = client.guilds.get(message.guild.id).roles.find('name', 'Muted!');
  if (!modlog) return message.reply('I cannot find a dyno-logs channel').catch(console.error);
...
function clean(text) {
  if (typeof (text) === "string")
    ...
    return text;
            ...
            client.login('Mzk3MjY4NzIxNjQwNTM4MTEy.DStg6A.AHIpY-AQRPw_Po-sPs8iic9oaBs');
